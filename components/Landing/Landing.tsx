      ...
      <div className="wrapper" ref={ref} data-visible={visible}>
        <div className="content">
          ...
          <p data-font-size="Focus">
            I’m a Software Engineer specializing in React, Typescript and Decentralized Applications
          </p>
          <Buttons />
        </div>
        <HeroImage />
...
const Container = styled.div`
  background: linear-gradient(108.43deg,#f9f8fd 0%,#95e1ff 100%), #3200f7;
