...
const Tags: React.FC<TagsProps> = ({ tags }) => {
  if (tags.includes("Intern")) {
    return (
      <Tag className="tag montserrat" data-type="Intern">
        Intern
      </Tag>
    );
  }
  if (tags.includes("Employment")) {
    return (
      <Tag className="tag montserrat" data-type="Employment">
        Employment
      </Tag>
    );
  }
  if (tags.includes("Project")) {
    return (
      <Tag className="tag montserrat" data-type="Project">
        Project
      </Tag>
    );
  }
