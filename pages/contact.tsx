...
const ContactPage: NextPage = () => {
  ...
  return (
    <>
      <NextSeo
        title="Timi Coker - Contact me"
        description="My mail, telegram and contact information."
        canonical="timicoker.github.io/personal-site/contact"
        openGraph={{
          url: "timicoker.github.io/personal-site/contact",
          title: "Timi Coker - Contact me",
          description: "My mail, telegram and contact information.",
        }}
      />
      ...
      <Main>
        <div>
          <Cards data-fix-width ref={ref} data-visible={visible}>
            ...
            <div className="cards">
              <Link
                href="mailto:timicoker@gmail.com"
                target="_blank"
